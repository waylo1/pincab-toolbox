...
/// <summary>Micro test framework: every public static void method starting with "Test_" is a test.
/// Same pattern as PincabToolbox.Core.Tests/TestRunner.cs, duplicated rather than shared — this
/// project deliberately does not reference Core.Tests (see the csproj comment for why it exists
/// standalone at all).</summary>

...
public static class Loc
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["repair.tag"] = "Repair (Pro) · soon — one-click fix",
        ...
        ["about.roadmap"] = "Coming next: Repair (Pro) — optional one-click fixes for some of what the scanner finds, always with a backup first, a preview of every change, and undo. The free scanner always stays read-only. Follow the forum thread to be notified.",
    ...
    private static readonly Dictionary<string, string> Fr = new()
    {
        ...
        ["repair.tag"] = "Repair (Pro) · bientôt — réparation en un clic",
        ...
        ["about.roadmap"] = "Bientôt : Repair (Pro) — des réparations optionnelles en un clic pour une partie de ce que le scanner trouve, toujours avec sauvegarde avant, aperçu de chaque changement et annulation. Le scanner gratuit reste toujours en lecture seule. Suis le fil du forum pour être prévenu.",
        ["about.version"] = "Version",

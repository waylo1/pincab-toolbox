...
public static class Loc
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        // 20/08 — per-change detail in the "Repaired" list (Maxime, real tester: only saw file
        // names before, not what was actually done). Keyed by IRepairAction.Id — an action added
        // later without an entry here still shows its raw Before/After text (see BuildPlanSummaryText).
        ["repair.action.unblock_file"] = "unblocked from Windows",
        ["repair.action.restore_rom_archive"] = "ROM archive restored",
        ["repair.action.kill_zombie_pinup_display"] = "stuck process closed",
        ["repair.action.quarantine_orphaned_media"] = "orphaned file quarantined",
        ["repair.action.register_com_component"] = "registration tool launched",
        ["repair.action.set_default_audio_device"] = "default audio device changed",
        // 20/08 — bouton bascule du panneau de détail (voir MainWindow.ListFindings_SelectionChanged
        // et Settings.ExpertMode). Le libellé affiché est celui du mode ACTUEL (comme les boutons de
        // langue) : cliquer dessus bascule vers l'autre mode.
        ["mode.expert"] = "Expert",
        ["mode.beginner"] = "Beginner",
        ["mode.expert.tooltip"] = "Showing technical detail (cause, explanation, verification). Click to switch to Beginner mode.",
        ["mode.beginner.tooltip"] = "Showing simplified detail only. Click to switch to Expert mode.",
        ...
        ["tutorial.step1.body"] = "In the Scanner tab, click \"Browse…\" to point to your VPX / PinUP Popper installation folder (or \"Demo mode\" to see an example without touching your own files), then click \"Start scan\". The scan is 100% local and never changes anything.\n\nIt runs over 30 checks across six areas: ROMs and scripts, 32-bit/64-bit compatibility, install completeness (backglasses, Popper registration, media), table compatibility and updates, DMD/audio/display setup, and system health (blocked files, dependencies, NVRAM). A full scan usually takes under a minute.",
        ...
        ["tutorial.step6.title"] = "6. Beginner / Expert mode",
        ["tutorial.step6.body"] = "In the Scanner tab, click any result line to open its detail panel on the right. The green \"Expert\" / \"Beginner\" button (top right, next to EN/FR/ES) switches how much detail that panel shows: Expert displays the full technical breakdown (impact, cause, explanation, verification), Beginner keeps only the plain-language symptom and fix. This button only affects that detail panel — it has no effect on the Repair tab's checklist.",
    ...
    private static readonly Dictionary<string, string> Fr = new()
    {
        ...
        ["repair.action.unblock_file"] = "débloqué (Windows)",
        ["repair.action.restore_rom_archive"] = "archive ROM restaurée",
        ["repair.action.kill_zombie_pinup_display"] = "processus bloqué fermé",
        ["repair.action.quarantine_orphaned_media"] = "fichier orphelin mis en quarantaine",
        ["repair.action.register_com_component"] = "outil d'enregistrement lancé",
        ["repair.action.set_default_audio_device"] = "périphérique audio par défaut changé",
        ["mode.expert"] = "Expert",
        ["mode.beginner"] = "Débutant",
        ["mode.expert.tooltip"] = "Détail technique affiché (cause, explication, vérification). Cliquer pour passer en mode Débutant.",
        ["mode.beginner.tooltip"] = "Détail simplifié uniquement. Cliquer pour passer en mode Expert.",
        ...
        ["tutorial.step1.body"] = "Dans l'onglet Scanner, cliquez sur « Parcourir… » pour indiquer le dossier de votre installation VPX / PinUP Popper (ou « Mode démo » pour voir un exemple sans toucher à vos propres fichiers), puis cliquez sur « Lancer le scan ». Le scan est 100 % local et ne modifie jamais rien.\n\nIl effectue plus de 30 vérifications réparties en six familles : ROMs et scripts, compatibilité 32/64 bits, complétude de l'installation (backglasses, enregistrement Popper, médias), compatibilité des tables et mises à jour, configuration DMD/audio/écran, et santé système (fichiers bloqués, dépendances, NVRAM). Un scan complet prend généralement moins d'une minute.",
        ...
        ["tutorial.step6.title"] = "6. Mode Débutant / Expert",
        ["tutorial.step6.body"] = "Dans l'onglet Scanner, cliquez sur une ligne de résultat pour ouvrir son panneau de détail à droite. Le bouton vert « Expert » / « Débutant » (en haut à droite, à côté de EN/FR/ES) règle le niveau de détail affiché dans ce panneau : Expert montre tout le détail technique (impact, cause, explication, vérification), Débutant ne garde que le symptôme et le correctif en langage simple. Ce bouton n'agit QUE sur ce panneau de détail — il ne change rien à la liste de l'onglet Repair.",
    ...
    private static readonly Dictionary<string, string> Es = new()
    {
        ...
        ["repair.action.unblock_file"] = "desbloqueado (Windows)",
        ["repair.action.restore_rom_archive"] = "archivo ROM restaurado",
        ["repair.action.kill_zombie_pinup_display"] = "proceso bloqueado cerrado",
        ["repair.action.quarantine_orphaned_media"] = "archivo huérfano puesto en cuarentena",
        ["repair.action.register_com_component"] = "herramienta de registro iniciada",
        ["repair.action.set_default_audio_device"] = "dispositivo de audio predeterminado cambiado",
        ["mode.expert"] = "Experto",
        ["mode.beginner"] = "Principiante",
        ["mode.expert.tooltip"] = "Detalle técnico mostrado (causa, explicación, verificación). Clic para pasar a modo Principiante.",
        ["mode.beginner.tooltip"] = "Solo se muestra el detalle simplificado. Clic para pasar a modo Experto.",
        ...
        ["tutorial.step1.body"] = "En la pestaña Escáner, haga clic en «Examinar…» para indicar la carpeta de su instalación VPX / PinUP Popper (o «Modo demo» para ver un ejemplo sin tocar sus propios archivos), y luego haga clic en «Iniciar escaneo». El escaneo es 100% local y nunca cambia nada.\n\nRealiza más de 30 comprobaciones repartidas en seis áreas: ROMs y scripts, compatibilidad de 32/64 bits, integridad de la instalación (backglasses, registro en Popper, medios), compatibilidad de tablas y actualizaciones, configuración de DMD/audio/pantalla, y salud del sistema (archivos bloqueados, dependencias, NVRAM). Un escaneo completo suele tardar menos de un minuto.",
        ...
        ["tutorial.step6.title"] = "6. Modo Principiante / Experto",
        ["tutorial.step6.body"] = "En la pestaña Scanner, haga clic en cualquier línea de resultado para abrir su panel de detalle a la derecha. El botón verde «Experto» / «Principiante» (arriba a la derecha, junto a EN/FR/ES) ajusta el nivel de detalle mostrado en ese panel: Experto muestra todo el detalle técnico (impacto, causa, explicación, verificación), Principiante conserva solo el síntoma y la solución en lenguaje sencillo. Este botón solo afecta a ese panel de detalle, no cambia nada en la lista de la pestaña Repair.",
